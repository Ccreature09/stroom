...
export default async function WarehouseConfigsPage({
  ...
  const [warehouse] = await db
    ...
    .leftJoin(
      warehouseConfigs,
      eq(warehouses.configId, warehouseConfigs.configId),
    )
    .where(
      and(
            ...
            <form action={updateWarehouseConfig} className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="text-sm font-semibold text-slate-700">
                  ...
                  <input
                    ...
                    maxLength={20}
                    defaultValue={
                      warehouse.defaultPutawayStrategy ?? "NEAREST_EMPTY"
                    }
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                <label className="flex items-center gap-2 rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700">
                  <input
                    ...
                    defaultChecked={
                      warehouse.requireStagingBeforePutaway ?? true
                    }
              ...
              {employee.canModifyConfigs ? (
                ...
                <p className="text-sm font-medium text-amber-700">
                  You do not have permission to modify configs for this
                  warehouse.
                </p>
              )}
            </form>
