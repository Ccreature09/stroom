...
import {
  DEFAULT_TEMPLATES,
  GENERATOR_TO_LOCATION_TYPE,
  MAX_PATTERN_SLOTS,
  buildFloorLineLocations,
  buildRackingLocations,
  buildShelvingLocations,
  estimatePatternSlots,
  parsePattern,
  type Axis1DDirection,
  type BulkGeneratorType,
  type BulkLocationDraft,
  type Orientation,
  type PatternPhase,
} from "@/lib/warehouse-map/bulk-generator";
