...
CREATE TABLE "halls" (
	...
	"name" varchar(100) NOT NULL,
	"physical_width_mm" integer DEFAULT 80000 NOT NULL,
	"physical_length_mm" integer DEFAULT 60000 NOT NULL,
	"clear_height_mm" integer DEFAULT 12000,
	"is_active" boolean DEFAULT true,
	"created_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
	"updated_at" timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT "uq_warehouse_hall_name" UNIQUE("warehouse_id","name")
);
--> statement-breakpoint
...
CREATE TABLE "locations" (
	...
	"is_racking" boolean NOT NULL,
	"is_shelf" boolean NOT NULL,
	"is_floor_storage" boolean NOT NULL,
	"updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
	"physical_x" integer DEFAULT 0 NOT NULL,
	"physical_y" integer DEFAULT 0 NOT NULL,
	"physical_width_mm" integer DEFAULT 0 NOT NULL,
	"physical_length_mm" integer DEFAULT 0 NOT NULL,
	...
	CONSTRAINT "chk_rotation_range" CHECK ((rotation_degrees >= 0) AND (rotation_degrees < 360))
);
--> statement-breakpoint
...
CREATE TABLE "position_types" (
	...
	"can_modify_layout" boolean DEFAULT false,
	"warehouse_id" integer,
...
CREATE TABLE "zone_types" (
	...
	"requires_barcode_scan" boolean DEFAULT true NOT NULL,
	"storage_permanence" varchar(20) DEFAULT 'PERMANENT' NOT NULL,
	"color" varchar(7),
	CONSTRAINT "uq_zones_wh_name" UNIQUE("warehouse_id","name"),
	CONSTRAINT "chk_storage_permanence" CHECK ((storage_permanence)::text = ANY ((ARRAY['PERMANENT'::character varying, 'TEMPORARY'::character varying, 'FLUID_BUFFER'::character varying])::text[]))
);
--> statement-breakpoint
...
ALTER TABLE "halls" ADD CONSTRAINT "fk_halls_warehouse" FOREIGN KEY ("organization_id","warehouse_id") REFERENCES "public"."warehouses"("warehouse_id","organization_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "locations" ADD CONSTRAINT "locations_hall_id_fkey" FOREIGN KEY ("hall_id") REFERENCES "public"."halls"("hall_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "locations" ADD CONSTRAINT "locations_zone_id_fkey" FOREIGN KEY ("zone_id") REFERENCES "public"."zone_types"("zone_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "position_types" ADD CONSTRAINT "position_types_warehouse_id_fkey" FOREIGN KEY ("warehouse_id") REFERENCES "public"."warehouses"("warehouse_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "zone_types" ADD CONSTRAINT "zones_warehouse_id_fkey" FOREIGN KEY ("warehouse_id") REFERENCES "public"."warehouses"("warehouse_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "idx_warehouse_halls_wh_id" ON "halls" USING btree ("warehouse_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "idx_locations_canvas_render" ON "locations" USING btree ("warehouse_id" int4_ops,"hall_id" int4_ops,"physical_x" int4_ops,"physical_y" int4_ops) WHERE (is_blocked = false);--> statement-breakpoint
CREATE INDEX "idx_locations_zone_lookup" ON "locations" USING btree ("warehouse_id" int4_ops,"hall_id" int4_ops,"zone_id" int4_ops);--> statement-breakpoint
CREATE INDEX "idx_position_types_warehouse_id" ON "position_types" USING btree ("warehouse_id" int4_ops);--> statement-breakpoint
...
CREATE INDEX "idx_time_clock_employee" ON "time_clock_entries" USING btree ("employee_id" int4_ops);